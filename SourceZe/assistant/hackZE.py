...
from SourceZe import bot, mody
#By Source ze @Source_Ze
...
'''
mm = '''
قم بلأنضمام الى قناة  زد إي @Source_Ze
'''
...
keyboard = [
  ...
  [
    Button.url("سورس  زد إي 🔱", "https://t.me/Source_Ze")
    ]
]
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/Source_Ze")
        ]
    ]
