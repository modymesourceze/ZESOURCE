...
class SourceZeClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
...
SourceZeClient.fast_download_file = download_file
SourceZeClient.fast_upload_file = upload_file
SourceZeClient.reload = restart_script
SourceZeClient.get_msg_link = get_message_link
SourceZeClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    SourceZeClient.send_message = send_message
    SourceZeClient.send_file = send_file
    SourceZeClient.edit_message = edit_message
