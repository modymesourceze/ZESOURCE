...
c = requests.session()
bot_username = '@Egy404_bot'
ze = ['yes']


@mody.on(admin_cmd(pattern="(تجميع مصر|مصر)"))
async def _(event):
    if ze[0] == "yes":
        ...
        await mody.send_message('@Egy404_bot', '/start')
        await asyncio.sleep(5)
        msg0 = await mody.get_messages('@Egy404_bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await mody.get_messages('@Egy404_bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await mody.get_messages('@Egy404_bot', limit=1)
