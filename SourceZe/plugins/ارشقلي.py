...
@mody.on(admin_cmd(pattern="(تجميع ارشقلي|ارشقلي)"))
async def _(event):
    if ze[0] == "yes":
        ...
        await mody.send_message('@Ershkalibot', '/start')
        await asyncio.sleep(5)
        msg0 = await mody.get_messages('@Ershkalibot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await mody.get_messages('@Ershkalibot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await mody.get_messages('@Ershkalibot', limit=1)
